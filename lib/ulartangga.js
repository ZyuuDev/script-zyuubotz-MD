...
class SnakeAndLadderGame {
  constructor(sMsg) {
    ...
    this.playerImageUrls = {
      red: "https://i.ibb.co.com/Xk4MwCrq/amongus-red.png",
      green: "https://i.ibb.co.com/chzHXxS9/image-removebg-preview.png",
    }
    this.bgImage = null
    this.playerImages = {
      red: null,
  ...
  formatPlayerName = async (player) => {
    const color = this.getPlayerColor(player)
    return `${await conn.tagUser(player)} ( ${color.charAt(0).toUpperCase() + color.slice(1)} )`
  }
