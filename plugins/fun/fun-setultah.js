let handler = async (m, { conn, usedPrefix, command, text, senderKey }) => {
    ...
    switch (command) {
        case 'setultah':
        case 'setulta':
            if (typeof ultah[senderKey] !== "undefined") return conn.textList(m.chat, "Kamu sudah mendaftarkan tanggal lahir kamu, apakah kamu ingin menggantinya?", false, [[`${usedPrefix}delete-ultah iya`, "Iya"], [`${usedPrefix}delete-ultah tidak`, "Tidak"]], m)
