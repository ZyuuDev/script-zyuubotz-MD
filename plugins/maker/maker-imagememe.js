...
let handler = async(m, { senderKey, conn, usedPrefix, args, command }) => {
    try {
        ...
        let pp = await conn.profilePictureUrl(quotedKey).catch(_ => fs.readFileSync('./src/avatar_contact.png'))
        let caption = `
